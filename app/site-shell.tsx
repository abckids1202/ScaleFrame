...
export function SiteShell({ children, active = "" }: { children: React.ReactNode; active?: string }) {
  return <div className="site-shell">
    <header className="topbar">
      ...
      <div className="top-actions"><Link className="text-button" href="/settings">Account</Link><Link className="button button-small button-light" href="/#workspace">Create <span>↗</span></Link></div>
    </header>
    {children}
